...
This is a full-stack web application built with Node.js and Express.
The app includes a password-protected login system and a real-time chat
that works simultaneously for multiple users.
...
- Deployed to cloud hosting (Render)
...
- Reaaliaikainen chat Socket.IO:n avulla
- Uloskirjautuminen ja session mitätöinti
...
- Tunnistautuminen: express-session, bcrypt
